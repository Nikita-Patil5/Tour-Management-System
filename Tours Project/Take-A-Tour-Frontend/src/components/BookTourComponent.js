...
export default function BookTour(props) {
    ...
    // console.log("location. state value"+location.state.onepackge)
    ...
    useEffect(() => {
       ...
       // console.log("....const"+(tinfo));
        setTousristinfo(JSON.parse(tinfo)); 
        console.log("touristinfo info"+touristinfo)
    ...
    useEffect(() => {
        ...
        const pinfo =(localStorage.getItem("packageforBookTour"));
        console.log(pinfo);
        
       // console.log("....const"+(tinfo));
       setPackageinfo(JSON.parse(pinfo)); 
    ...
    const validateData = (name, value) => {
        ...
        switch (name) {
            case "travellernumber":
               ...
               if(value<=0 || value>packageinfo.availseats)
               {
                    hasError = true;
                    error = "Enter number between 1 to "+packageinfo.availseats+""
              }
              break;
                    ...
                    <Row md={2} >
                        ...
                        <Col>
                           ...
                           <table className="c-tabletouristinfo">
                                ...
                                <tr className="c-bookbuttondiv" >
                                   <td>
                                   <button type="submit" className="btn  btn-block" id="c-bookbutton" onClick={(e) => { sendData(e) }}>Book</button>
                        ...
                        <Col>
                            <div className="c-booktourinnerdiv " >
                                ...
                                <tr className="c-bookbuttondiv" >
                                   <td>
                                   <button type="submit" className="btn  btn-block" id="c-bookbutton" onClick={(e) => { sendDataoftraveller(e) }}>Submit</button>
